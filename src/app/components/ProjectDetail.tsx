...
const projectData = {
  'chess-robot': {
    ...
    fullDescription: `
      This project combines computer vision, deep learning, and robotics to create a robot capable of playing chess against human opponents.
      ...
      • Accurate piece identification (chessboard segmentation)
      • Precise robotic arm trajectory planning
      • Real-time move validation
      • Error recovery for physical disturbances
  ...
  'gesture-control': {
    ...
    fullDescription: `
      A human-robot interaction system enabling control of a 3D-printed robotic hand through hand gestures.
      ...
      • Natural interaction for users with mobility challenges
  ...
  'multi-robot-solar': {
    ...
    fullDescription: `
      This project focuses on developing an innovative multi-robot system that combines solar-powered Unmanned Ground Vehicles (UGVs) and Unmanned Aerial Vehicles (UAVs) for efficient area exploration and coverage.
      ...
      The system focuses on:
      • Maximizing aerial coverage with drones
      • Minimizing energy consumption
      • Dynamic coordination for optimized task allocation
      • UGV repositioning for extended UAV operational range

      The UGVs serve as mobile charging stations, harvesting solar energy to recharge both themselves and the UAVs. UAVs perform aerial searches and return to their respective UGVs for recharging as needed.
  ...
  'ur5-trajectory': {
    ...
    fullDescription: `
      This project focuses on planning and executing trajectories for the UR5 robotic arm, generating smooth and continuous motions using advanced trajectory planning techniques.
    ...
    github: "https://github.com/BenharJohn/trajectory_planning",
    demo: "https://youtube.com/demo",
    results: [
  ...
  'weather-forecasting': {
    ...
    fullDescription: `
      This project focuses on creating a robust weather forecasting system by leveraging historical weather data and advanced predictive models.
      ...
      Model Performance:
      • SARIMA: RMSE 3.55, MAE 2.94
      • LSTM: RMSE 0.10, MAE 0.08
      • Ensemble: RMSE 1.57, MAE 1.22
  ...
  'smart-home': {
    ...
    fullDescription: `
      A comprehensive smart home automation system that integrates various IoT devices and sensors for intelligent home control and monitoring.
  ...
  'ai-chatbot': {
    ...
    fullDescription: `
      An advanced chatbot system that uses natural language processing to automate customer service interactions across multiple platforms.
    ...
    demo: "https://demo.ai-chatbot.com",
    results: [
  ...
  'data-analytics': {
    ...
    fullDescription: `
      A comprehensive platform for processing and analyzing large-scale data streams in real-time, featuring interactive dashboards and automated reporting.
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-12">
              {project.tech.map((tech, index) => (
                <span
                  key={index}
                  className="px-4 py-2 bg-zinc-900 rounded-full text-sm border border-zinc-800"
                >
                  {tech}
                </span>
              ))}
